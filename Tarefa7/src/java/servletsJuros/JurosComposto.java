 ...
 */
@WebServlet(name = "JurosComposto", urlPatterns = {"/AndersonFranciellyJurosComposto.json"})
...
"            body{background: linear-gradient(to right, blue, gold);}\n" +
"            h4 {color: white} h3 {color: white}" + "</Style>");
            
            out.println("<title>Servlet AndersonFranciellyJurosCompostoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
